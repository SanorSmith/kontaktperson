...
const mockVolunteers = [
  ...
  // Göteborg (South-West Sweden)
  {
    id: '6',
    full_name: 'Lars Andersson',
    email: 'lars.a@email.se',
    phone: '070-678 90 12',
    age: 42,
    municipality: 'Göteborg',
    languages: ['Svenska', 'Engelska', 'Tyska'],
    interests: ['Fotboll', 'Resor'],
    availability: ['Vardagar', 'Kvällar'],
    available_for: ['Ungdomar', 'Vuxna'],
    experience_level: 'experienced',
    has_drivers_license: true,
    has_car: true,
    status: 'approved',
  ...
  },
  {
    ...
    email: 'karin.n@email.se',
    phone: '070-789 01 23',
    age: 35,
    municipality: 'Göteborg',
    languages: ['Svenska', 'Norska'],
    interests: ['Matlagning', 'Yoga'],
    availability: ['Helger'],
    available_for: ['Barn', 'Alla åldrar'],
    experience_level: 'beginner',
    has_drivers_license: false,
    has_car: false,
    status: 'approved',
  ...
  // Malmö (South Sweden)
  {
    ...
    email: 'ahmed.h@email.se',
    phone: '070-890 12 34',
    age: 29,
    municipality: 'Malmö',
    languages: ['Svenska', 'Arabiska', 'Engelska'],
    interests: ['Fotboll', 'Musik'],
    availability: ['Vardagar', 'Helger'],
    available_for: ['Ungdomar', 'Vuxna'],
    experience_level: 'experienced',
    has_drivers_license: true,
  ...
  {
    id: '9',
    full_name: 'Emma Karlsson',
    email: 'emma.k@email.se',
    phone: '070-901 23 45',
    age: 31,
    municipality: 'Malmö',
    languages: ['Svenska', 'Engelska', 'Danska'],
    interests: ['Läsning', 'Promenader'],
    availability: ['Kvällar', 'Helger'],
    available_for: ['Barn', 'Ungdomar'],
    experience_level: 'experienced',
    has_drivers_license: true,
  ...
  {
    id: '10',
    full_name: 'Peter Olsson',
    email: 'peter.o@email.se',
    phone: '070-012 34 56',
    age: 48,
    municipality: 'Uppsala',
    languages: ['Svenska', 'Engelska'],
    interests: ['Historia', 'Böcker'],
    availability: ['Vardagar'],
    available_for: ['Alla åldrar'],
    experience_level: 'expert',
    has_drivers_license: true,
  ...
  {
    id: '11',
    full_name: 'Linda Bergström',
    email: 'linda.b@email.se',
    phone: '070-123 45 78',
    age: 27,
    municipality: 'Uppsala',
    languages: ['Svenska', 'Franska'],
    interests: ['Konst', 'Dans'],
    availability: ['Kvällar', 'Helger'],
    available_for: ['Barn', 'Ungdomar'],
    experience_level: 'beginner',
    has_drivers_license: false,
  ...
  {
    id: '12',
    full_name: 'Mikael Lundgren',
    email: 'mikael.l@email.se',
    phone: '070-234 56 89',
    age: 39,
    municipality: 'Umeå',
    languages: ['Svenska', 'Engelska', 'Finska'],
    interests: ['Skidåkning', 'Natur'],
    availability: ['Vardagar', 'Helger'],
    available_for: ['Ungdomar', 'Vuxna'],
    experience_level: 'experienced',
    has_drivers_license: true,
  ...
  {
    id: '13',
    full_name: 'Sofia Eriksson',
    email: 'sofia.e@email.se',
    phone: '070-345 67 90',
    age: 33,
    municipality: 'Umeå',
    languages: ['Svenska', 'Samiska'],
    interests: ['Hantverk', 'Kultur'],
    availability: ['Helger'],
    available_for: ['Alla åldrar'],
    experience_level: 'experienced',
    has_drivers_license: true,
  ...
  {
    id: '14',
    full_name: 'Anders Nordin',
    email: 'anders.n@email.se',
    phone: '070-456 78 01',
    age: 44,
    municipality: 'Luleå',
    languages: ['Svenska', 'Engelska'],
    interests: ['Fiske', 'Friluftsliv'],
    availability: ['Vardagar', 'Kvällar'],
    available_for: ['Vuxna', 'Alla åldrar'],
    experience_level: 'expert',
    has_drivers_license: true,
  ...
  {
    id: '15',
    full_name: 'Helena Sjöberg',
    email: 'helena.s@email.se',
    phone: '070-567 89 12',
    age: 36,
    municipality: 'Luleå',
    languages: ['Svenska', 'Finska', 'Engelska'],
    interests: ['Musik', 'Teater'],
    availability: ['Kvällar', 'Helger'],
    available_for: ['Barn', 'Ungdomar'],
    experience_level: 'experienced',
    has_drivers_license: false,
  ...
  {
    id: '16',
    full_name: 'Gustav Ström',
    email: 'gustav.s@email.se',
    phone: '070-678 90 23',
    age: 41,
    municipality: 'Örebro',
    languages: ['Svenska', 'Engelska'],
    interests: ['Cykling', 'Matlagning'],
    availability: ['Vardagar'],
    available_for: ['Ungdomar', 'Vuxna'],
    experience_level: 'experienced',
    has_drivers_license: true,
  ...
  {
    id: '17',
    full_name: 'Camilla Åberg',
    email: 'camilla.a@email.se',
    phone: '070-789 01 34',
    age: 30,
    municipality: 'Örebro',
    languages: ['Svenska', 'Spanska', 'Engelska'],
    interests: ['Resor', 'Fotografi'],
    availability: ['Helger'],
    available_for: ['Barn', 'Alla åldrar'],
    experience_level: 'beginner',
    has_drivers_license: true,
  ...
  // Kiruna (Far North Sweden)
  {
    id: '18',
    full_name: 'Björn Larsson',
    email: 'bjorn.l@email.se',
    phone: '070-890 12 45',
    age: 50,
    municipality: 'Kiruna',
    languages: ['Svenska', 'Samiska', 'Engelska'],
    interests: ['Jakt', 'Natur'],
    availability: ['Vardagar', 'Helger'],
    available_for: ['Alla åldrar'],
    experience_level: 'expert',
    has_drivers_license: true,
  ...
  // Linköping (South-Central Sweden)
  {
    id: '19',
    full_name: 'Annika Forsberg',
    email: 'annika.f@email.se',
    phone: '070-901 23 56',
    age: 34,
    municipality: 'Linköping',
    languages: ['Svenska', 'Engelska', 'Kinesiska'],
    interests: ['Teknologi', 'Spel'],
    availability: ['Kvällar', 'Helger'],
    available_for: ['Ungdomar', 'Vuxna'],
    experience_level: 'experienced',
    has_drivers_license: true,
  ...
  {
    id: '20',
    full_name: 'Daniel Hedlund',
    email: 'daniel.h@email.se',
    phone: '070-012 34 67',
    age: 37,
    municipality: 'Linköping',
    languages: ['Svenska', 'Engelska'],
    interests: ['Sport', 'Film'],
    availability: ['Vardagar'],
    available_for: ['Barn', 'Ungdomar'],
    experience_level: 'experienced',
    has_drivers_license: true,
...
const municipalities = ['Stockholm', 'Solna', 'Huddinge', 'Göteborg', 'Malmö', 'Uppsala', 'Umeå', 'Luleå', 'Örebro', 'Kiruna', 'Linköping'];
